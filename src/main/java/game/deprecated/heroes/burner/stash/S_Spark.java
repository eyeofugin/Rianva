package game.deprecated.heroes.burner.stash;
...
public class S_Spark extends Skill {
    ...
    public S_Spark(Hero hero) {
        super(hero);
        this.iconPath = "entities/heroes/burner/icons/spark.png";
        addSubscriptions();
        setToInitial();
    }
    @Override
    public void setToInitial() {
        ...
        this.dmgMultipliers = List.of(new Multiplier(Stat.MANA, 0.3));
