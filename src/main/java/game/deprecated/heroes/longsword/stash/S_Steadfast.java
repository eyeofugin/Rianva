package game.deprecated.heroes.longsword.stash;
...
public class S_Steadfast extends Skill {
    ...
    public S_Steadfast(Hero hero) {
        super(hero);
        this.iconPath = "entities/heroes/longsword/icons/steadfast.png";
        addSubscriptions();
        setToInitial();
    }
    ...
    public String getDescriptionFor(Hero hero) {
        return "+2"+Stat.STAMINA.getIconString()+" when receiving damage (+10 max.).";
    }
