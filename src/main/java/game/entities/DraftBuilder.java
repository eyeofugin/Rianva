...
public class DraftBuilder {
  ...
  public static List<Class<? extends Hero>> pos0List =
      List.of(
          //            H_Burner.class,
          //            H_DarkMage.class,
          //            H_DivineMage.class,
  ...
  public static List<Class<? extends Hero>> pos1List =
      List.of(
          //            H_TheWizard.class,
          //            H_Rifle.class,
          //            H_DualPistol.class
          );
  public static List<Class<? extends Hero>> pos2List =
      List.of(
          //            H_AngelGuy.class,
          //            H_Duelist.class,
          //            H_FireDancer.class,
  ...
  public static List<Class<? extends Hero>> pos3List =
      List.of(
          //            H_BattleAxe.class,
          //            H_CryoBrawler.class,
          //            H_DragonBreather.class,
  ...
  public static Hero getHeroFromClassList(
      List<Class<? extends Hero>> availClasses, List<Hero> exclusions) {
  ...
  public static List<Hero> getDungeonDraft() {
    ...
    draftOptions.add(getRdmPos0Hero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmPos1Hero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmPos2Hero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmPos3Hero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmFlexHero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmFlexHero(drafted));
    drafted.add(draftOptions.get(draftOptions.size() - 1));
    draftOptions.add(getRdmFlexHero(drafted));
  ...
  private static Hero getRandFromPreset(
      Map<String, List<DraftEntityDTO>> container, String role, List<String> drafted) {
  ...
  public static Hero buildHeroFromPreset(String preset, String role, int nr) {
    ...
    if (container == null || container.get(role) == null) {
      return null;
    }
