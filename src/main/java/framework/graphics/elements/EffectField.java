...
public class EffectField extends GUIElement {
  ...
  private void setArrows(int listSize) {
    String leftIconName =
        this.relativePointer > pointer ? "scrollArrowActive_l" : "scrollArrowInactive_l";
    ...
    boolean rightActive =
        Math.max(0, listSize - 1) - this.relativePointer > (AMOUNT_VISIBLE_EFFECTS - 1) - pointer;
