...
public class Connector {
  ...
  public static String LETHALITY_PERMANENT_BASE_CHANGES = "ACCURACY_BASE_CHANGES";
  public static String LETHALITY_PERMANENT_MULT_CHANGES = "ACCURACY_MULT_CHANGES";
