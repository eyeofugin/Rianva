...
public class MyMaths {
  ...
  public static int percentageOf(double percentage, int amount) {
    double carryOver = percentage * amount;
    return (int) (carryOver / 100);
  }
  ...
  public static int[] getIntArrayWithExclusiveRandValues(int from, int until, int size) {
  ...
  public static int getFromToIncl(int from, int to, List<Integer> exclude) {
    Random rand = new Random();
    boolean found = false;
